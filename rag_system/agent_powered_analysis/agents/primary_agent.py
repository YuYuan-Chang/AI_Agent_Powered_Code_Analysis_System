...
from ..utils.prompts import PRIMARY_AGENT_SYSTEM_PROMPT, PRIMARY_AGENT_USER_PROMPT
    ...
    def understand_query(self, user_query: str) -> PrimaryAgentResponse:
        ...
        try:
            ...
            messages = [
                ...
                {"role": "user", "content": PRIMARY_AGENT_USER_PROMPT.format(user_query=user_query)}
            ]
